package com.wy.kafka.bean;

/**
 * @author wuyong
 * @date 2015年12月29日 上午11:30:00
 */
public class SVD {
     ...
     * @author wuyong
     */
    public boolean setFieldsByString1(String[] str) {
        try {
            // 吴永提供的测试数据分析
             ...
             * </p>
             * <p>
             * 三所提供的文本格式 1） 车辆消息的文本格式 <br/>
             * "event_id", "time", "camera_id", "plate", "model", "type",
             * "color", "seatbelt", "visor", "url" <br/>
             * 2） 非标车辆消息的文本格式<br/>
    ...
    public String toString() {
        return "SVD [id=" + id + ", monitorInfoId=" + monitorInfoId + ", vhcUrl=" + vhcUrl + ", carNumber=" + carNumber
                + ", carBrand=" + carBrand + ", carModel=" + carModel + ", carYear=" + carYear + ", carSeries="
                + carSeries + ", carSpeed=" + carSpeed + ", currentDate1=" + currentDate1 + ", currentAddress="
                + currentAddress + ", carBrandColor=" + carBrandColor + ", carColor=" + carColor
